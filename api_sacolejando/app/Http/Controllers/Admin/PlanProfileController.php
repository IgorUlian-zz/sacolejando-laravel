...
class PlanProfileController extends Controller
{
    ...
    public function permissionsAvailable(Request $request, $idPlan)
    {   
    ...
    public function attachPermissionsProfile(Request $request, $idPlan)
    {   
    ...
    public function detachPermissionsProfile($idPlan, $idProfile)
    {      
        ...
        $profile = $this->profile->find($idProfile);
            ...
            return redirect()->route('profiles.plans', $plan->id);
        }
}