...
@section('title', "Permissões do Perfil {$plan->profile_name}")

@section('content_header')

<ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="{{route('plans.index')}}">Dashboard</a></li>
    <li class="breadcrumb-item active"><a href="{{route('plans.index')}}">Permissões</a></li>

</ol>

<h1>Permissões disponíveis no perfil <strong>{{$plan->plan_name}}</strong></h1>
