...
<div class="form-group">
    <label>* Nome:</label>
    <input type="text" name="name" class="form-control" placeholder="Nome:" value="{{ $tenant->tenant_name?? old('name') }}">
</div>
<div class="form-group">
    <label>* E-mail:</label>
    <input type="email" name="email" class="form-control" placeholder="E-mail:" value="{{ $tenant->tenant_email ?? old('email') }}">
</div>
<div class="form-group">
    <label>* CNPJ:</label>
